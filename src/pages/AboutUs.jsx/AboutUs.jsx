      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          <h1 className="mb-4 text-4xl font-bold md:text-5xl playfair">
            About <span className="text-primary">Read On Route</span>
          </h1>
          <p className="mx-auto max-w-3xl text-base-content/70">
            Read On Route is a modern reading platform designed to help people
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-20 grid gap-10 md:grid-cols-2 md:items-center"
        >
          <div>
        ...
        >
          ...
          <p className="mx-auto mb-6 max-w-2xl text-base-content/70">
            Read On Route is more than an app — it's a habit, a community, and a
